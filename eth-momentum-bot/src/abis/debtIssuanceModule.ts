export const DebtIssuanceModuleABI = [
  {
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_maxManagerFee", type: "uint256" },
      { internalType: "uint256", name: "_managerIssueFee", type: "uint256" },
      { internalType: "uint256", name: "_managerRedeemFee", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "maxManagerFee", type: "uint256" },
      { internalType: "uint256", name: "managerIssueFee", type: "uint256" },
      { internalType: "uint256", name: "managerRedeemFee", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_newIssueFee", type: "uint256" },
    ],
    name: "updateIssueFee",
    outputs: [],
    stateMutability: "nonpayable",
